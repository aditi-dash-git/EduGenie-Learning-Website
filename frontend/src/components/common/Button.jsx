...
const Button = ({
  ...
  const variantStyles = {
    primary: 'bg-gradient-to-r from-blue-500 to-indigo-500 text-white shadow-lg shadow-blue-500/25 hover:from-blue-600 hover:to-indigo-600 hover:shadow-xl hover:shadow-blue-500/30',
