  ...
  return courseData ? (
    <>
      <div className="bg-gradient-to-b from-cyan-100/70 min-h-screen">
        <div className="flex md:flex-row flex-col-reverse gap-10 items-start justify-between md:px-36 px-8 pt-20 text-left">
          {/* left column */}
          <div className="max-w-xl z-10 text-gray-500">
            ...
            <p className="text-sm">
              Course by{" "}
              <span className="text-blue-600 underline">EduGenie</span>
            </p>
    ...
    border-t border-gray-300"
          ...
          {/* right column */}
          <div
            className="max-w-[424px] z-10 shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] rounded-t
